 ...
 * @author mihaylov
 */
public class CustomUdpDataSource implements DataSource {
    ...
    private final TransferListener<? super CustomUdpDataSource> listener;
     ...
     */
    public CustomUdpDataSource(TransferListener<? super CustomUdpDataSource> listener) {
     ...
     */
    public CustomUdpDataSource(TransferListener<? super CustomUdpDataSource> listener, int maxPacketSize) {
